...
class LoginForm(FlaskForm):
    email = StringField('Email Address', validators=[DataRequired('Email address is required'),
                                                     Email(
...
class RegistrationForm(FlaskForm):
    ...
    player_level = IntegerField('Trainer Level',
                                validators=[DataRequired(), NumberRange(1, 40)])
    player_team = RadioField('Select Your Team',
                             choices=[('Mystic', 'Mystic'), ('Instinct', 'Instinct'),
                                      ('Valor', 'Valor'), ('Harmony', 'Harmony')],
                             validators=[DataRequired()])
